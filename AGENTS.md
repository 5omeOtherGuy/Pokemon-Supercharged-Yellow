...
The authoritative initial requirements are in ADR-0001. In particular:
...
Do not silently adopt earlier assistant suggestions as requirements. Engine choice, roster boundaries, exact mechanics generation, cap values, IV/EV/nature policy, Set mode, bag-item restrictions, starters, Yellow-specific events, speed presets and prototype boundaries remain unresolved.
