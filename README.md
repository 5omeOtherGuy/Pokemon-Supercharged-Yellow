...
- Ordinary stat-training points require entering battle, never fainting and a team victory. Switched-out survivors qualify; previously earned points are retained regardless of later outcomes. Stat training should usually require additional focused battles after levelling; the extra duration remains open.
