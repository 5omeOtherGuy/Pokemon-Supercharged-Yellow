...
- ADR-0024 was Proposed at audit completion. Preparation goals and uncertainty about AI reliability did not accept unrestricted hidden-state access or the proposed active-passive disclosure fields at that point.
...
Subsequent move/information clarification, 2026-09-05: ADR-0011 explicitly requires weather/terrain moves, forgettable HMs and reusable TMs. The user accepts ADR-0024's reciprocal active-effect disclosure while retaining hidden-stat and pending-action protections. ADR-0021 records the user's HM-access recollection; other inherited badge effects remain undecided.
