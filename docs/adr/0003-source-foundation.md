...
- Complete solo acquisition of all original 151 under ADR-0004, with no player/NPC trading or trade-dependent evolutions; Mew under the truck under ADR-0026; removal of obedience restrictions under ADR-0021. Assess story-state access and alternative acquisition paths together.
