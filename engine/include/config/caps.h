...
// Level Cap Configs
#define B_EXP_CAP_TYPE                  (P_SC_KANTO_RULES ? EXP_CAP_HARD : EXP_CAP_NONE)
#define B_LEVEL_CAP_TYPE                (P_SC_KANTO_RULES ? LEVEL_CAP_FLAG_LIST : LEVEL_CAP_NONE)
#define B_LEVEL_CAP_VARIABLE            0 // event variable used to derive level cap if B_LEVEL_CAP_TYPE is set to LEVEL_CAP_VARIABLE

#define B_RARE_CANDY_CAP                P_SC_KANTO_RULES
