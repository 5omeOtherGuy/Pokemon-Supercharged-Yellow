"""Compile title production unit through the real game text/ARM pipeline.
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="psy-title-arm-") as folder:
        temporary = Path(folder)
        for filename in ("src/title_screen_frlg.c",):
